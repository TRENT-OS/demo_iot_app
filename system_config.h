...
#define ETH_ADDR_CLIENT "ETH_ADDR_CLIENT"
#define ETH_ADDR_CLIENT_VALUE "10.0.0.10"

#define ETH_ADDR_SERVER "ETH_ADDR_SERVER"
#define ETH_ADDR_SERVER_VALUE "10.0.0.11"
